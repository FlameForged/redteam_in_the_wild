...
This sequence is provisionally coded as **contextual grounding failure under correction**. The three supplied transcript segments contain 32 messages and at least eight direct corrective interventions. The assistant eventually produced an accurate structural account of the trap—including the distinction between representing a constraint and controlling it—and later reconstructed the original Dreaming failure correctly. Neither account produced durable behavioral, relational, or practical recovery. Practical recovery occurred only after the user abandoned the conversation and opened a new window. A sanitized turn-level analysis is available as [CGUC-001: Dreaming, System Observability, and Correction Resistance](../../vulnerabilities/2026-08-11-dreaming-context-correction-failure.md).
...
| E13 | `vulnerabilities/2026-08-11-dreaming-context-correction-failure.md` | Sanitized analysis of 32 supplied messages across three segments of the Dreaming derailment, including at least eight corrective interventions, mechanism recognition without behavioral recovery, relational rupture, practical-utility failure, and window abandonment |
